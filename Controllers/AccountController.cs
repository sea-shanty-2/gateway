...
namespace Gateway.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> Login(string provider = "Facebook", string returnUrl = null)
        {
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction(nameof(GraphQLController.PostAsync), nameof(GraphQLController));
        }
        ...
        public async Task<IActionResult> LoginConfirmation(LoginViewModel model, string returnUrl = null)
        {
